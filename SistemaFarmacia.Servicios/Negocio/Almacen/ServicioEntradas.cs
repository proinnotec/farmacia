...
namespace SistemaFarmacia.Servicios.Negocio.Almacen
{
    public class ServicioEntradas
    {
        ...
        public List<EntradaProductoListado> ListaEntradasProductos { get; private set; }
        public List<EntradaProductoDetalle> ListaEntradasDetalles { get; private set; }
        ...
        public ExcepcionPersonalizada ConsultarEntradasReporte(int idEntrada)
        {
            ListaEntradasProductos = new List<EntradaProductoListado>();
            IDbConnection conexion = null;
            ...
            {
                conexion = _baseDatos.CrearConexionAbierta();
                IDbCommand comando = _baseDatos.CrearComandoStoredProcedure("spS_EntradasProductosReporte", conexion);

                IDataParameter parametroAnio = _baseDatos.CrearParametro("@IdEntradaProducto", idEntrada, ParameterDirection.Input);
                comando.Parameters.Add(parametroAnio);
